...
use crate::config::{
    GITEA_DEFAULT_BASE_URL, GITHUB_DEFAULT_BASE_URL, GITLAB_DEFAULT_BASE_URL,
...
pub fn set_config_remote(
    ...
    match package_config.remote.clone() {
...
pub fn get_cliff_config(
    ...
    set_config_basic_settings(&mut cliff_config, &package_config)?;
    set_config_remote(&mut cliff_config, &package_config);
    set_config_tag_settings(&mut cliff_config, &package_config)?;

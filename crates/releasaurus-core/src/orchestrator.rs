...
/// # Operations
///
/// - [`create_release_prs`][Self::create_release_prs] — analyze
///   commits and open or update a release PR
/// - [`create_releases`][Self::create_releases] — detect a merged
///   release PR, tag the commit, and publish the release
/// - [`get_next_releases`][Self::get_next_releases] — preview the
///   projected next release without making any changes
/// - [`get_current_releases`][Self::get_current_releases] — fetch
///   the most recent published release per package
/// - [`start_next_release`][Self::start_next_release] — bump patch
///   versions to start the next development cycle
///
/// # Example
///
/// ```rust,no_run
...
///     forge::manager::{ForgeManager, ForgeOptions},
///     orchestrator::{
///         Orchestrator,
///         config::OrchestratorConfig,
///         package::resolved::{
...
///     },
/// };
/// # let forge_manager: ForgeManager = todo!();
/// # let orch_config: Rc<OrchestratorConfig> = todo!();
/// # let resolved: Vec<ResolvedPackage> = vec![];
///
...
///         ResolvedPackageHash::new(resolved).unwrap(),
///     ))
///     .forge(Rc::clone(&fm))
///     .build()
///     .unwrap();
